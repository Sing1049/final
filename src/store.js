...
export default new Vuex.Store({
  ...
  actions: {
    signUp ({ commit, dispatch }, authData) {
      axiosAuth
        // Web API key
        // AIzaSyCaYI68vY8BKU_vE072CFVWWg2zj5RBxCw
        // https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=[API_KEY]
        .post('accounts:signUp?key=AIzaSyCaYI68vY8BKU_vE072CFVWWg2zj5RBxCw', {
    ...
    signIn ({ commit, dispatch }, authData) {
      axiosAuth
        .post(
          'accounts:signInWithPassword?key=AIzaSyCaYI68vY8BKU_vE072CFVWWg2zj5RBxCw',
          {
            email: authData.email,
            password: authData.password,
            returnSecureToken: true
    ...
    storeUser ({ state }, userData) {
      ...
      globalAxios
        .post(
          'https://sing1049-final-assignment.firebaseio.com/users.json' +
            '?auth=' +
            state.idToken,
          userData
        )
...
// database =https://sing1049-final-assignment.firebaseio.com/
//  key =AIzaSyCaYI68vY8BKU_vE072CFVWWg2zj5RBxCw
